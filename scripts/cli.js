...
const contractABI = require("../artifacts/contracts/Audiophilemeld.sol/Audiophilemeld.json").abi;

program
    .name("audiophilemeld-cli")
    .description("CLI tool for Audiophilemeld smart contract")
    .version("1.0.0");
